                    ...
                    <div class="container">
                        <div class="row">
                          <div class="col col-md-6 col-sm-4">
                                ...
                                <p>Instituto Sonorense de Transparencia Acceso a la Información y Protección de Datos Personales.</p>
            ...
            <div class="header cd-header-block ">
                ...
                <div class="navbar mega-menu" role="navigation">
                    <div class="container">
                        ...
                        <!-- Start Navbar Brand -->
                        <div class="navbar-brand" style="width:100%; max-width:250px;" >
                                <a href="<?=$CONFIG['sitio']?>index.php" >
                                    <img class="header-logo"  src="<?=$CONFIG['sitio']?>img/istai/istai_logo.jpg" alt="Logo">
                                </a>
                		</div>
                        <div class="navbar-brand" style="width:100%; max-width:700px;">
            
                            <div class="row">
                                <div class="text-center media-middle">
                                    <h4>Instituto Sonorense de Transparencia Acceso a la Información y Protección de Datos Personales</h4>
                                </div>
                            </div>
                        </div>
                            <!-- End Navbar Brand -->
